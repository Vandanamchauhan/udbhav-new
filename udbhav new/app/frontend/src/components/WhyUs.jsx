...
const ITEMS = [
  {
    ...
    desc: "We engineer forward-looking automation designed for real hospitality environments, not labs.",
    span: "md:col-span-8",
  },
  {
    icon: ShieldCheck,
    title: "Reliable",
    desc: "Built to run all day, every day.",
    span: "md:col-span-4",
  },
  {
  ...
  },
  {
    ...
    desc: "We help restaurants, cafés, hotels, food courts, hospitals and retail step confidently into the future of service.",
    span: "md:col-span-8",
  },
];
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <h2 className="font-display font-bold tracking-tight text-[#0A0A0A] mt-4 text-3xl md:text-4xl lg:text-5xl leading-tight max-w-3xl">
          Technology you can trust, from a team that gets service
        </h2>
        ...
        <div className="mt-14 grid grid-cols-1 md:grid-cols-12 gap-6">
          {ITEMS.map((item, i) => {
            ...
            return (
              ...
              >
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-orange-50 text-[#FF4500]">
                  <Icon size={24} />
                </div>
