  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <span className="uppercase tracking-[0.2em] text-xs font-bold text-[#FF4500]">
          Get in Touch
        </span>
        <motion.h2
          ...
          <div className="space-y-8">
            {details.map((d) => {
              ...
              return (
                ...
                >
                  <span className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-white/10 text-[#FF4500] group-hover:bg-[#FF4500] group-hover:text-white transition-colors duration-300">
                    <Icon size={22} />
                  </span>
                  <span>
                    <span className="block text-sm text-zinc-400 font-body">{d.label}</span>
                    <span className="block text-lg md:text-xl font-display font-bold group-hover:text-[#FF4500] transition-colors">
                      {d.value}
                    </span>
                  </span>
                </a>
            ...
            <div className="flex items-start gap-4" data-testid="contact-address">
              <span className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-white/10 text-[#FF4500]">
                <MapPin size={22} />
              </span>
              <span>
              ...
              {socials.map((s) => {
                ...
                return (
                  <a
                    ...
                    className="inline-flex h-14 w-14 items-center justify-center rounded-xl border border-white/15 text-white hover:bg-[#FF4500] hover:border-[#FF4500] transition-colors duration-300"
                  >
                    <Icon size={22} />
                  </a>
                );
