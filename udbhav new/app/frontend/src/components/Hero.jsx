      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7">
          <motion.span
            ...
            className="inline-flex items-center gap-2 uppercase tracking-[0.2em] text-xs font-bold text-[#FF4500] bg-orange-50 border border-orange-100 rounded-full px-4 py-2"
          >
          ...
          >
            <button
              ...
              className="group inline-flex items-center gap-2 rounded-full bg-[#FF4500] text-white font-body font-bold px-7 py-4 hover:bg-orange-600 transition-colors duration-300"
            >
              Explore Products
