    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-10 grid lg:grid-cols-12 gap-12 items-center">
        ...
        <motion.div
          ...
          className="lg:col-span-5 flex items-center justify-center order-2 lg:order-2"
        >
          <motion.img
            ...
            className="h-60 md:h-80 lg:h-96 xl:h-[500px] w-auto object-contain drop-shadow-2xl"
          />
        </motion.div>
      </div>
    </section>
